...
//
//	mockgen -package=sshtoken_test -destination=sshtoken_mock_test.go -write_tool_generate_directive . LagoonDBService,KeycloakTokenService
//
...
//go:generate go tool mockgen -package=sshtoken_test -destination=sshtoken_mock_test.go -write_tool_generate_directive . LagoonDBService,KeycloakTokenService
