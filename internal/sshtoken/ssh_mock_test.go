...
//
//	mockgen -package=sshtoken_test -destination=ssh_mock_test.go -write_tool_generate_directive github.com/gliderlabs/ssh Session,Context
//
...
//go:generate go tool mockgen -package=sshtoken_test -destination=ssh_mock_test.go -write_tool_generate_directive github.com/gliderlabs/ssh Session,Context
