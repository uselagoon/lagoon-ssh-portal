...
//
//	go tool mockgen -source=permission.go -package=rbac_test -destination=permission_mock_test.go -write_generate_directive
//
...
//go:generate go tool mockgen -source=permission.go -package=rbac_test -destination=permission_mock_test.go -write_generate_directive
