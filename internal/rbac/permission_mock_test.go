...
//
//	mockgen -source=permission.go -package=rbac_test -destination=permission_mock_test.go -write_tool_generate_directive
//

// Package rbac_test is a generated GoMock package.
package rbac_test
...
//go:generate go tool mockgen -source=permission.go -package=rbac_test -destination=permission_mock_test.go -write_tool_generate_directive
